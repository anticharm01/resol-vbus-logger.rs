...
impl<'a> PngGenerator<'a> {
    pub fn from_config(config: &Config) -> Result<PngGenerator<'a>> {
        ...
        let img = if config.png_tick_interval > 0 {
            Some(image::open(&config.png_input_filename).context("Unable to open PNG image")?)
        } else {
            None
        };
        ...
        let font = match Font::try_from_vec(font) {
            Some(font) => font,
            None => return Err(anyhow!("Unable to parse font")),
        };
    ...
    pub fn generate(&self, data_set: &DataSet, now: &DateTime<UTC>) -> Result<()> {
        ...
        let mut img = match self.img {
            ...
            None => return Err(anyhow!("No image loaded")),
        };
        ...
        let scale = Scale { x: 22.0, y: 22.0 };
        let value = field_map
            .get("00_7210_6521_10_0100_002_2_0")
        ...
        let scale = Scale { x: 22.0, y: 22.0 };
        let value = field_map
            .get("00_7210_6521_10_0100_000_2_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 22.0, y: 22.0 };
        let value = field_map
            .get("00_0010_7210_10_0100_000_2_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 22.0, y: 22.0 };
        let value = field_map
            .get("00_0010_7210_10_0100_010_2_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 22.0, y: 22.0 };
        let value = field_map
            .get("00_0010_7210_10_0100_004_2_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 22.0, y: 22.0 };
        let value = field_map
            .get("00_7210_6521_10_0100_004_2_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 24.0, y: 24.0 };
        let value = field_map
            .get("00_0010_7210_10_0100_024_2_0")
            .unwrap_or(&default_str);
        ...
        let scale = Scale { x: 24.0, y: 24.0 };
        let value = field_map
            .get("00_6521_7210_10_0200_032_1_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([0u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 20.0, y: 20.0 };
        let value = field_map
            .get("00_6521_7210_10_0200_000_1_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 20.0, y: 20.0 };
        let value = field_map
            .get("00_6521_7210_10_0200_024_1_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 20.0, y: 20.0 };
        let value = field_map
            .get("00_0010_7210_10_0100_020_1_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 20.0, y: 20.0 };
        let value = field_map
            .get("00_0010_7210_10_0100_021_1_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 20.0, y: 20.0 };
        let value = field_map
            .get("00_0010_7210_10_0100_023_1_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 22.0, y: 22.0 };
        let value = field_map
            .get("00_0010_7210_10_0100_002_2_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([128u8, 0u8, 0u8, 255u8]),
            457,
            329,
            scale,
            &self.font,
        ...
        let scale = Scale { x: 22.0, y: 22.0 };
        let value = field_map
            .get("00_0010_7210_10_0100_006_2_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([128u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 22.0, y: 22.0 };
        let value = field_map
            .get("00_0010_7210_10_0100_008_2_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([128u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 20.0, y: 20.0 };
        let value = field_map
            .get("00_6521_7210_10_0200_008_1_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 20.0, y: 20.0 };
        let value = field_map
            .get("00_6521_7210_10_0200_016_1_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 22.0, y: 22.0 };
        let value = field_map
            .get("00_7210_6521_10_0100_008_2_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 22.0, y: 22.0 };
        let value = field_map
            .get("00_0010_7210_10_0100_018_2_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 22.0, y: 22.0 };
        let value = field_map
            .get("00_7210_6521_10_0100_006_2_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([255u8, 0u8, 0u8, 255u8]),
        ...
        let scale = Scale { x: 20.0, y: 20.0 };
        let value = field_map
            .get("00_0010_7211_10_0100_000_2_0")
            .unwrap_or(&default_str);
        draw_text_mut(
            &mut img,
            Rgba([0u8, 0u8, 0u8, 255u8]),
